    ...
    <div className="">
      <div className="w-full bg-white  overflow-hidden">
        ...
        <div className="p-2 space-y-4">
          {/* Tournament Name */}
          <div>
            <label className="text-lg font-semibold mb-1 block">Tournament Name</label>
            <input
              type="text"
              value={formData.name}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-lg font-semibold mb-1 block">Start Date</label>
              <input
                type="date"
            ...
            <div>
              <label className="text-lg font-semibold mb-1 block">End Date</label>
              <input
                type="date"
          ...
          {/* Tournament Stages */}
          <div>
            <label className="text-lg font-semibold mb-2 block">Tournament Stages</label>
          ...
          {/* Player Type */}
          <div>
            <label className="text-lg font-semibold mb-2 block">Tournament Player Type</label>
            <div className="space-y-2">
              {[
          ...
          {/* Tournament Type */}
          <div>
            <label className="text-lg font-semibold mb-2 block">Tournament Type</label>
            <div className="space-y-2">
              {[
          ...
          {/* Email */}
          <div>
            <label className="text-lg text-gray-500 mb-1 block">Enter Organizer Email/AridNo</label>
            <input
              type="email"
