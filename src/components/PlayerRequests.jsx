...
import { getPlayerRequestsByPlayerId, approvePlayerRequest, rejectPlayerRequest } from "../api/playerRequestApi";
                        ...
                        {requests.map((req) => (
                            ...
                            >
                                <div>
                                    ...
                                    <h4 className="text-sm font-medium text-gray-600">Creator: {req.teamCreatorName || "Unknown Creator"}</h4>
