                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-red-600 text-white">
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide rounded-tl-xl">Team</th>
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide text-center">P</th>
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide text-center">W</th>
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide text-center">L</th>
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide text-center">Pts</th>
                            <th className="p-4 font-semibold text-sm uppercase tracking-wide text-center rounded-tr-xl">NRR</th>
                        </tr>
                    </thead>
