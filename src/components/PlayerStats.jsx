            ...
            <div className="bg-white rounded-lg shadow-md p-4">
                <div className="flex gap-3 overflow-x-auto">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-all whitespace-nowrap ${activeView === "overall"
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-all whitespace-nowrap ${activeView === "tournament"
                                ? "bg-red-500 text-white"
                                : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                            }`}
                    >
                ...
                <div className="bg-white rounded-lg shadow-md p-4">
                    ...
                    <div className="flex gap-3 overflow-x-auto">
                        <button
                            ...
                            className={`px-4 py-2 rounded-full font-medium transition-all whitespace-nowrap border-2 flex items-center gap-2 ${selectedSport === "cricket"
